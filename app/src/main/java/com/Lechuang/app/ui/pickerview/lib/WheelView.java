package com.Lechuang.app.ui.pickerview.lib;
...
import com.Lechuang.app.ui.pickerview.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        textSize = getResources().getDimensionPixelSize(R.dimen.textsize_20);
        ...
        if(attrs != null) {
            ...
            textSize = a.getDimensionPixelOffset(R.styleable.wheelview_textSize_,textSize);
        }
