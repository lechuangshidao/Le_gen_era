 ...
 */
public abstract class BaseDataActivity extends SimpleTopbarActivity implements ActivityPresenter, OnGestureListener {
	 ...
	 * @warn 不能在子类中创建
	 */
	protected BaseDataActivity context = null;
	/**
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		context = (BaseDataActivity) getActivity();
		isAlive = true;
